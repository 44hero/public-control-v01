        ...
        - 修正箇所11
            ...
            - 詳細: カスタムの Script Editor2 (PySide2作成UI) で置き換える為には、
                ...
                ::
                    ...
                    +   # 追加11 ########################################################### start
                        # ここで、CustomScriptEditor2 の closedシグナル を購読していますdef scriptEditor2_chunk1(self):
                            ...
...
# ローカルで作成したモジュール
import YO_utilityTools.scaleConstraintByMatrix.config as docstring
...
class SConByMat_View(object):
    ...
    def __init__(self, _model):
        ...
        self.infoSummary = (u'scale constraint byMatrix ツール\n'
    ...
    def editMenuCloseCmd(self, *args):
        ...
        # message(args[0])  # pm.deleteUI(self.win)
