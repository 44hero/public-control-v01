...
#
# パッケージ内のモジュールの更新を都度反映するように記述 ####################### start
import YO_utilityTools.TemplateForPySide2.type1  # type1 パッケージに対して
...
# print(fileName)  # templateForPySide2_type1_main.py
# print(directory1)  # TemplateForPySide2
# print(directory2)  # type1
# print(parentDir)  # YO_utilityTools

# 基本的にはモジュール実行ベースの記述だが、
# PyCharm等のデバッグポート使用時のスクリプト実行も可能にするため、あえてパッケージ宣言
__package__ = f'{parentDir}.{directory1}.{directory2}'  # "YO_utilityTools.TemplateForPySide2"
# あえてパッケージ宣言  ####################### end
...
from .templateForPySide2_type1_View import Tpl4PySide2_Type1_View
...
def main():
    ...
    """
    m = Tpl4PySide2_Type1_Modl()
    v = Tpl4PySide2_Type1_View(m)
    Tpl4PySide2_Type1_Ctlr(v, m)
